    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {filtered.map(p => {
          ...
          return (
            <div key={p.id} className={`rounded-lg border bg-white p-3 ${disabled ? 'opacity-60' : ''}`}>
              ...
              <button className="mt-2 w-full px-3 py-2 rounded bg-gray-100 text-gray-700 text-sm" disabled>
                Em breve
              </button>
            </div>
          )
