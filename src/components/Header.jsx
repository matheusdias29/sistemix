...
import { Bell, X, Info, CheckCircle, AlertTriangle, AlertCircle, Sun, Moon, LifeBuoy } from 'lucide-react'
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        {typeof onToggleDarkMode === 'function' ? (
          <div className="flex flex-col items-center leading-none">
            <button
              ...
              className="p-1.5 md:p-2.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400 transition-colors relative"
              title={darkMode ? 'Modo escuro' : 'Modo claro'}
            >
              {darkMode ? <Moon className="w-5 h-5 md:w-6 md:h-6" /> : <Sun className="w-5 h-5 md:w-6 md:h-6" />}
            </button>
            <div className="hidden md:block mt-1 text-[10px] font-semibold text-gray-500 dark:text-gray-400">{darkMode ? 'Modo escuro' : 'Modo claro'}</div>
          </div>
        ) : null}
        ...
        {typeof onToggleChat === 'function' ? (
          <div className="flex flex-col items-center leading-none">
            <button
              ...
              className={`p-1.5 md:p-2.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400 transition-colors relative ${chatOpen ? 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200' : ''}`}
              title="Chat interno"
            >
              ...
              {chatUnreadCount > 0 && (
                <span className="absolute top-0.5 right-0.5 md:top-1.5 md:right-1.5 h-3 w-3 md:h-4 md:w-4 bg-red-500 text-white text-[8px] md:text-[10px] font-bold flex items-center justify-center rounded-full border-2 border-white dark:border-gray-900">
                  {chatUnreadCount > 9 ? '9+' : chatUnreadCount}
                </span>
              )}
            </button>
            <div className="hidden md:block mt-1 text-[10px] font-semibold text-gray-500 dark:text-gray-400">Chat interno</div>
          </div>
        ) : null}
        ...
        {typeof onToggleCalculator === 'function' ? (
          <div className="flex flex-col items-center leading-none">
            <button
              ...
              className={`p-1.5 md:p-2.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400 transition-colors relative ${calculatorOpen ? 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200' : ''}`}
              title="Calculadora"
            >
            ...
            <div className="hidden md:block mt-1 text-[10px] font-semibold text-gray-500 dark:text-gray-400">Calculadora</div>
          </div>
        ) : null}
        ...
        <div className="relative" ref={notificationRef}>
          <div className="flex flex-col items-center leading-none">
            ...
            <div className="hidden md:block mt-1 text-[10px] font-semibold text-gray-500 dark:text-gray-400">Notificações</div>
          </div>
        ...
        <div className="flex flex-col items-center leading-none">
          ...
          <div className="hidden md:block mt-1 text-[10px] font-semibold text-gray-500 dark:text-gray-400">Suporte</div>
        </div>
