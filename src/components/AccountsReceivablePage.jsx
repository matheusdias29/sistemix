...
export default function AccountsReceivablePage({ storeId, user, store }) {
  ...
  const handleDelete = async (id) => {
    if (!isOwner && !perms.receivables?.delete) {
      alert('Sem permissão para excluir contas a receber.')
      return
    }
      ...
      {detailGroup && (
        ...
        >
          ...
          >
            ...
            <div className="px-6 border-b flex items-center justify-between mt-2 shrink-0">
