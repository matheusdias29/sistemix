...
import { listenSubUsers, addSubUser, updateSubUser } from '../services/users'
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        {filtered.map((u, i) => (
          <div key={u.id} className="grid grid-cols-[1.5rem_1fr_10rem_8rem_2rem] items-center px-4 py-3 border-b last:border-0">
            <div className="text-gray-400">👤</div>
            <div className="text-sm">
              <div className="font-medium cursor-pointer" onClick={() => startEdit(u)}>{u.name || '-'}</div>
